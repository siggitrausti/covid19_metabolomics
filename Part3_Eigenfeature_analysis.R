...
load('final_data_workspace_24NOV2022.Rdata')
...
png("traits_vs_modules_24NOV2022.png",width = 1200,height = 2000,units = 'px',res = 150)
par(mar = c(7, 7, 1, 1));
...
# Save workspace:
save.image("final_data_workspace_24NOV2022_PART2.RData")

################################################################################
# Part 2: Save all datasets to be used in Jupyter for Random Forest modeling. 
write.csv(MEs,"MEs_dataframe_24NOV2022.csv", row.names = FALSE)
write.csv(patients,"patients_vector_24NOV2022.csv", row.names = FALSE)
write.csv(clin_dat,"clinical_dataframe_24NOV2022.csv", row.names = FALSE)
write.csv(FinalData,"Final_dataframe_24NOV2022.csv", row.names = FALSE)
write.csv(mergedColors2,"module_assignments_24NOV2022.csv", row.names = FALSE)
write.csv(datKME2,"datkme_24NOV2022.csv", row.names = FALSE)
