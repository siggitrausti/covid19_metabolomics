...
dat <- read.csv('All_data_normalised_15SEP2022.csv')
...
net = blockwiseModules(FinalData, power = 4,networkType = 'unsigned',TOMType = 'signed Nowick',corFnc = 'bicor',
...
save.image("final_data_workspace_15SEP2022.RData")
